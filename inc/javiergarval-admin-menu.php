...
function javiergarval__general() {
  ...
  // Configurar opciones
	...
	function javiergarval_front_email() {
		...
		$email2 = esc_attr( get_option( 'javiergarval__header_email-2' ) );
		echo '
		<input id="email_field_" type="email" name="javiergarval__header_email-1" value="'.$email1.'" placeholder="Correo Electrónico" size="35"/>
		<input id="email_field_" type="text" name="javiergarval__header_email-2" value="'.$email2.'" placeholder="Web" size="35"/>
		';
...
function javiergarval__products() {
  ...
  add_settings_section('javiergarval__products-section', '', 'javiergarval__products_section', 'javiergarval-admin-products');
  function javiergarval__products_section() {}

  add_settings_field('javiergarval-products-database', 'Registro de compras', 'javiergarval_products_database', 'javiergarval-admin-products', 'javiergarval__products-options');

  function javiergarval_products_database() {
    $p_master = esc_attr(get_option('p_master'));
    echo '
    	<h3>Testimonio 1</h3>
    	<input type="text" name="javiergarval__content-testimony-author-1" value="'.$p_master.'" placeholder="Autor" />';
  }
}// javiergarval__products()
...
========================================
*/
function javiergarval__users() {}// javiergarval__users()
