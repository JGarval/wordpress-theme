...
<form class="form-horizontal" name="Formulario javiergarval-oea" method="post" accept-charset="utf-8">
  <div class="form-group form-group_style" style="margin: 5px auto; ">
    ...
    <!-- Button -->
    <button name="enviar" type="submit" class="btn btn-primary" id="enviar" value="Enviar" style="background-color: #337ab7">Enviar</button>
